...
# Directory path
os.chdir("..")
cwd = 'F:\\MATH 110A\\optimization-ii-project-3'
...
for idx, test_batch in enumerate(test_loader):
    ...
    test_secret = test_secret.cuda()
    test_cover = Variable(test_cover, volatile=True)
    test_cover = test_cover.cuda()
